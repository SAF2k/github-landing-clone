      ...
      <div className="flex">
        ...
        <div className=" absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
          <div className="relative md:top-20 mb-[24px]">
            <Link
              href=""
              className="heroIcon border-[1px] border-neutral-600 copilot rounded-full inline-block"
            >
              <div className="flex items-center p-3 px-5">
                ...
                <div className="ml-auto">
                  <svg
                    ...
                    className={`hoverIcon text-white transition ease-in duration-150`}
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
          ...
          <div className="flex lg:w-11/12 md:space-x-5 max-md:flex-col">
            ...
            <Link
              href=""
              className="heroIcon flex items-center w-full md:w-auto justify-center text-[16px] py-3 px-5 max-md:mt-4 rounded-md border-[#ae88f9] border-[1.5px] text-white"
            >
              Start a free enterprise trial
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`hoverIcon arrow-symbol-mktg text-white ml-3 transition ease-in duration-150`}
                width="20"
                height="20"
                viewBox="0 0 16 16"
                fill="none"
