      ...
      >
        <div className="max-w-[1280px] mx-auto pb-2 lg:pb-3 pt-1 flex lg:px-3 px-12 items-center max-lg:flex-col relative">
          ...
          >
            <Link
              href=""
              className="heroIcon flex items-center max-lg:w-full text-white font-semibold justify-center space-x-2 text-base  border-[1px] border-neutral-500 px-3 py-3 rounded-md"
            >
              Start Link free enterprise trail
              <svg
            ...
            <Link
              href=""
              className="heroIcon flex items-center max-lg:w-full bg-white font-semibold px-3 py-3 justify-center rounded-md text-base"
            >
              Sign up for GitHub
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                ></path>
                <path
                  className={`hoverPath transition ease-in duration-150 opacity-0`}
                  stroke="currentColor"
                  d="M1.75 8H11"
                  strokeWidth="1.5"
                  strokeLinecap="round"
