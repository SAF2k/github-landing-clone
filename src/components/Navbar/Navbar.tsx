...
const ProductNav = dynamic(() => import("./ProductNav"));
const SolutionNav = dynamic(() => import("./SolutionNav"));
const OpenSourceNav = dynamic(() => import("./OpenSourceNav"));
        ...
        <div className="flex items-center max-lg:justify-between max-lg:flex-row-reverse">
          ...
          >
            <div className="flex max-lg:flex-col lg:items-center lg:justify-between max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px]  overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg">
              <nav className="mt-0 px-3 lg:px-6 text-[15.5px] mb-0 lg:mr-2 max-lg:py-10 max-lg:px-5">
              ...
              <div className="lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb-3 lg:mb-0 text-left lg:space-x-4">
                <div className="lg:flex mb-2 lg:mb-0 relative max-lg:mr-4">
                  <input
                    ...
                    className="glass max-lg:bg-neutral-50 max-lg:w-full w-[240px] xl:w-[390px] lg:px-2 h-[38px] max-lg:h-[41px] p-[3.5px] whitespace-nowrap overflow-hidden placeholder:text-[14px] max-lg:placeholder:text-[16px] font-medium placeholder:pl-2 focus:z-10 text-[14px] focus:outline-none focus:bg-white focus:text-black border lg:border-neutral-400 max-lg:border-neutral-300 rounded-lg"
                    type="text"
                  />
                  <svg
