        ...
        <div className="flex flex-col lg:flex-row py-10 mb-8 space-x-6 px-4">
          <div className="mb-12 px-2">
            ...
            <div className="text-white">
              ...
              <Link
                href=""
                className="mb-6 px-6 py-3 text-[17px] font-semibold border-[0.5px] border-gray-400 rounded-lg hover:bg-gray-900 active:bg-gray-500"
              >
                Subscribe
              </Link>
            </div>
            ...
            <div className="text-[#7d8590]">
              ...
              <ul className="text-[14px]">
                {footerItems[0].items.map((item) => (
                    <FooterList key={item.title}>{item.title}</FooterList>
                ))}
              </ul>
            </div>
            <div className="text-[#7d8590]">
