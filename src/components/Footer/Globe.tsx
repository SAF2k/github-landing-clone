        ...
        <div className="flex my-8 md:my-16 sm:my-12 relative md:items-center text-center flex-col">
          <div className="py-3 mb-2 flex flex-col justify-center items-center">
            ...
            <div className="lg:ml-5 flex items-center justify-center lg:space-x-5 max-lg:space-y-3 max-lg:flex-col max-lg:w-full max-lg:mt-5">
              <Link
                href=""
                className="heroIcon flex items-center bg-white font-bold px-14 py-3 justify-center rounded-md text-[20px]"
              >
                Sign up for GitHub
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`hoverIcon ml-2 transition ease-in duration-150`}
                  width="20"
                  height="20"
                  viewBox="0 0 16 16"
                  fill="none"
                >
                  ...
                  ></path>
                  <path
                    className={`hoverPath opacity-0  transition ease-in duration-150`}
                    stroke="currentColor"
                    d="M1.75 8H11"
                    strokeWidth="1.5"
                    strokeLinecap="round"
              ...
              <Link
                href=""
                className="heroIcon flex items-center text-white font-bold justify-center space-x-2 text-[20px]  border-[1px] border-neutral-500 px-4 py-3 rounded-md"
              >
                ...
                >
                  ...
                  ></path>
                  <path
                    className={`hoverPath opacity-0 text-white transition ease-in duration-150 origin-right`}
                    stroke="currentColor"
                    d="M1.75 8H11"
                    strokeWidth="1.5"
                    strokeLinecap="round"
